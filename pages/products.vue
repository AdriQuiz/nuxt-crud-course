<template>
    <section class="m-5 bg-slate-700 p-5 rounded-lg">
        ...
        <div class="mb-4">
            <button @click="openCreateModal" class="p-2 bg-cyan-400 rounded-lg">+ Create Product</button>
        </div>
        ...
        <ul class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
            <li v-for="product in products" :key="product._id" class="bg-slate-400 p-3 rounded-md">
                ...
                <div class="flex gap-4">
                    <button @click="openEditModal(product)" class="bg-yellow-300 px-3 py-2 rounded-md">Edit</button>
